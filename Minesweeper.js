...
async function NewGame(){
    ...
    } while (v.y * tempFieldSize + 220 >= window.screen.availHeight || v.x * tempFieldSize >= window.screen.availWidth * 0.9); // TODO Fix nem jo ha a két érték messze van egymástól
